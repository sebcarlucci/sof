...
#define CROSSOVER_TYPE_2WAY 2
#define CROSSOVER_TYPE_3WAY 3
#define CROSSOVER_TYPE_4WAY 4
 ...
 */
static inline crossover_process crossover_find_proc_func(enum sof_ipc_frame src_fmt)
{
	int i;
...
/**
 * \brief Retrieves Crossover passthrough processing functions.
 */
...
struct crossover_split_fnmap {
	uint32_t num_sinks;
	crossover_split crossover_split_func;
};

extern const struct crossover_split_fnmap crossover_split_fnmap[];
extern const size_t crossover_split_fncount;

/**
 * \brief Retrieves Crossover split function.
 */
